"""
FurnitureClassifier — 3-block custom CNN for 8-class indoor furniture recognition.
...
class FurnitureClassifier(nn.Module):
    def __init__(self, in_channels: int = 3, hidden_units: int = 10, num_classes: int = 8):
        super().__init__()
